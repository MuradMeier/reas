...
def init_db(request):
    ...
    # 1. Удаляем все тестовые данные (как в предыдущей версии)
    ...
    Vstrecha.objects.all().delete()
    Zayavka.objects.all().delete()
    Arenda.objects.all().delete()
    Prodazha.objects.all().delete()
    Klient.objects.all().delete()
    Komnata.objects.all().delete()
    Kvartira.objects.all().delete()
    ChastnyiDom.objects.all().delete()
    Mnogoetazhka.objects.all().delete()
    ZemelnyiUchastok.objects.all().delete()
